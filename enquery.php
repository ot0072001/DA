...
<?php
		function check_firstname(){
			...
			if(isset($_POST['submit'])){
				...
				{
					$errMsg = '<tr><td></td><td class="errMsg">Please enter your valid firstname</td></tr>';;
				}*/
			}
			return $errMsg;
		...
		function check_lastname(){
			...
			if(isset($_POST['submit'])){
				...
				/*else if(!preg_match("^[A-Z][a-zA-Z]*$", $lastname))
				{
					$errMsg = '<tr><td></td><td class="errMsg">Please enter your valid lastname</td></tr>';;
				}*/
			}
			return $errMsg;
...
<div id="container">
	<div id="subContainer">
		...
		<div id="mainContent">
			...
			<div id="subContent">
				...
				<div class="sidebar">
					<img class="iconEnquery" src="pic/enquery/sidebar1.gif" />
				</div>
					...
					<div class="form">
					 ...
					 <form name="enquiryForm" id="enquiryForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="dsform">
                            <tbody>
								<tr>
                                  <th colspan="2" align="left" valign="top" class="flabel" style="background:url(pic/enquery/headbg.gif) repeat;"><img src="pic/enquery/title.gif" width="115" height="31" alt="Your Details" /></th>
                                </tr>
							  ...
							  <?php echo check_firstname();?>
                                <tr>
                                    <td class="flabel">Last name</td>
                                    <td><input name="lastname" type="text" id="lastname" value="" size="32" maxlength="255" /></td>
                                </tr>
								<?php echo check_lastname();?>
                                <tr>
                                    <td class="flabel">Email address</td>
                                    <td><input name="email" type="text" id="email" value="" size="32" maxlength="255" /></td>

                                </tr>
								<?php echo check_email();?>
                                <tr>
                                    <td valign="top" class="flabel-green">Enquiry</td>
                                    <td class="flabel-green"><textarea name="enquiry" cols="40" rows="6" id="enquiry"></textarea></td>
                                </tr>
								<?php echo check_enquiry();?>
                                <tr>
                                    ...
                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
									  ...
									  <tr class="phoneErr">
										<td class="errMsg"><?php echo check_phone();?>
										</td>
										<td class="errMsg">
										<?php echo check_phonetype();?>
										</td>
									  </tr>
                                ...
                                <tr>
                                    ...
                                    <option value="">- Select -</option>
                                    <option value="8am-12pm" >8am-12pm</option><option value="12pm-5pm" >12pm-5pm</option><option value="5pm ¨C 7pm" >5pm ¨C 7pm</option>                                    </select>
                                    </td>
                                </tr>
								<?php echo check_contactime();?>
                                <tr>
	...
	<noscript>
  		...
  		<input type="hidden" name="recaptcha_response_field" value="manual_challenge"/>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td align="right"><input type="image" src = "pic/enquery/submit.gif" style="border:none;" value="submit" name="submit" /></td>
                                </tr>
                            </tbody>
                        </table>
                         </form>
